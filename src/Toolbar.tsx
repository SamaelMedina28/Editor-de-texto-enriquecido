    ...
    <>
      <nav className="toolbar">
        <div className="left">
          ...
          {/* Code */}
          <button onClick={comandos.toggleCode} className={editorState.isCode ? 'active' : ''}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* Heading 1 */}
          <button onClick={comandos.toggleHeading1} className={editorState.isHeading1 ? 'active' : ''}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
              <path d="M13 20H11V13H4V20H2V4H4V11H11V4H13V20ZM21.0005 8V20H19.0005L19 10.204L17 10.74V8.67L19.5005 8H21.0005Z"></path>
            </svg>
          </button>
          {/* Heading 2 */}
          <button onClick={comandos.toggleHeading2} className={editorState.isHeading2 ? 'active' : ''}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* Heading 3 */}
          <button onClick={comandos.toggleHeading3} className={editorState.isHeading3 ? 'active' : ''}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* Orden List */}
          <button onClick={comandos.toggleOrdenList} className={editorState.isOrdenList ? 'active' : ''}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* Link */}
          <button onClick={comandos.agregarLink} className={editorState.isLink ? 'active' : ''}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
